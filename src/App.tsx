        ...
        >
          ...
          <Card className="border-4 border-black shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] rounded-none bg-white relative overflow-hidden group">
            ...
            <CardHeader className="pt-8 pb-6 text-center">
              ...
              <CardDescription className="text-stone-500 text-sm mt-2 font-medium">Prijavite se e-mail adresom i jednokratnim pristupnim kodom (OTP). Lozinka nije potrebna.</CardDescription>
            </CardHeader>
            <CardContent className="px-8 pb-8">
              ...
              >
                ...
                {authAction === 'login' ? 'Prijava u tijeku...' : authAction === 'logout' ? 'Odjava u tijeku...' : 'Nastavi na prijavu e-mailom'}
              </Button>
              <ol className="mt-5 list-decimal pl-5 space-y-2 text-sm text-stone-600">
                <li>Na sljedećoj stranici unesite svoju e-mail adresu.</li>
                <li>Zatražite pristupni kod i provjerite svoj pretinac e-pošte.</li>
                <li>Unesite primljeni kod za ulazak u DocuFlow.</li>
              </ol>
              <p className="mt-4 text-xs text-stone-500">Prijava se dovršava na sigurnoj stranici Cloudflare Access.</p>
            </CardContent>
          </Card>
